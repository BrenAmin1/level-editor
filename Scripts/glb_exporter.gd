...
func build_export_mesh(top_plane_snapshot: Array, enclosed_snapshot: Dictionary = {}, neighbors_snapshot: Dictionary = {}) -> ArrayMesh:
...
func build_chunk_meshes(save_name: String, top_plane_snapshot: Array,
		chunk_size: Vector3i = CHUNK_SIZE, enclosed_snapshot: Dictionary = {}, neighbors_snapshot: Dictionary = {}) -> Dictionary:
...
func _build_chunk_mesh(chunk_tiles: Dictionary[Vector3i, int], full_tiles: Dictionary[Vector3i, int],
		top_positions: Dictionary[Vector3i, bool], top_plane_snapshot: Array,
		enclosed_snapshot: Dictionary = {}, neighbors_snapshot: Dictionary = {}) -> ArrayMesh:
